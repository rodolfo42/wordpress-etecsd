	...
	class Yop_Poll_Admin extends Yop_Poll_Plugin {
				...
				<table class="wp-list-table widefat fixed" cellspacing="0">
					...
					<tbody>
						<?php
							...
							?>
							<tr><th colspan="4"><?php _e( 'No answers defined!', 'yop_poll' ); ?></th></tr>
							<?php
							}
						?>
					</tbody>
						...
						<table class="wp-list-table widefat fixed" cellspacing="0">
							...
							<tbody>
								<?php
									...
									?>
									<tr><td colspan="2"><?php _e( 'No other answers defined!', 'yop_poll' ); ?></td></tr>
									<?php
									}
								?>
							</tbody>
		...
		<div class="wrap">
			...
			<form method="get">
				...
				<p class="search-box">
					...
					<input id="yop-poll-search-input" type="search" value="<?php if( isset( $_REQUEST['s'] ) ): echo esc_html( stripslashes( $_REQUEST['s'] ) ); endif; ?>" name="s" />
					<input id="search-submit" class="button" type="submit" value="<?php _e( 'Search Poll Bans', 'yop_poll' ); ?>" name="" />
				</p>
				<div class="tablenav top">
					<div class="alignleft actions">
						<select name="action">
										...
										<table cellspacing="0" class="links-table">
											<tbody>
												...
												<tr id="yop-poll-allow-multiple-answers-div" style="<?php echo $default_options['allow_multiple_answers'] == 'no' ? 'display: none;' : '';  ?>">
													...
													<td>
														<input id="yop-poll-allow-multiple-answers-number" type="text" name="yop_poll_options[allow_multiple_answers_number]" value="<?php echo $default_options['allow_multiple_answers_number']; ?>" />
													</td>
												</tr>
											</tbody>
										</table>
									...
									<div class="inside">
										...
										<tbody>
											<tr>
												...
												<td>
													<label for="yop-poll-use-captcha-no"><input id="yop-poll-use-captcha-no" <?php echo 'no' == $default_options['use_captcha'] ? 'checked="checked"' : '';  ?> type="radio" name="yop_poll_options[use_captcha]" value="no" /> <?php _e( 'No', 'yop_poll' ); ?></label>
													<label for="yop-poll-use-captcha-yes"><input id="yop-poll-use-captcha-yes" <?php echo 'yes' == $default_options['use_captcha']  ? 'checked="checked"' : '';  ?> type="radio" name="yop_poll_options[use_captcha]" value="yes" /> <?php _e( 'Yes', 'yop_poll' ); ?></label>
												</td>
											</tr>
											<tr>
												<th>
											...
											<tbody>
												...
												<?php if( 'no' ==  $default_options['has_auto_generate_poll_page'] ) { ?>
													<tr>
														...
														<td>
															<input <?php checked( 'yes', $default_options['auto_generate_poll_page'] ); ?> id="yop-poll-auto-generate-poll-page-yes" type="radio" value="yes" name="yop_poll_options[auto_generate_poll_page]" /><label for="yop-poll-auto-generate-poll-page-yes"><?php _e( 'Yes' , 'yop_poll'); ?></label>
															<input <?php checked( 'no', $default_options['auto_generate_poll_page'] ); ?> id="yop-poll-auto-generate-poll-page-no" type="radio" value="no" name="yop_poll_options[auto_generate_poll_page]" /><label for="yop-poll-auto-generate-poll-page-no"><?php _e( 'No' , 'yop_poll'); ?></label>
														</td>
													</tr>
													<?php } ?>
												<tr>
			...
			if ( is_admin() ) {
				...
				if ( $poll_id ) {
					...
					if ( 'yes' == $poll_options['use_captcha'] ) {
						...
						$img->text_color 	= new Yop_Poll_Securimage_Color(
							rand(0, 255),
							rand(0, 255),
							rand(0, 255)
						);
		...
		*/
			...
			<div class="meta-box-sortables ui-sortable" id="side-sortables">
				<div class="postbox " id="linksubmitdiv">
					...
					<div class="inside">
						...
						<br />
						<b><?php _e( 'Short on funds?', 'yop_poll' ); ?></b>
						<ul id="donate_ul">
							<li>
								<a target="_blank" href="http://wordpress.org/extend/plugins/yop-poll/"><b><?php _e( 'Rate YOP POLL 5&#9733;\'s on WordPress.org', 'yop_poll' ); ?></b></a>
							</li>
							<li>
								<b><?php _e( 'Talk about it on your site and link back to the', 'yop_poll' ); ?></b>
								<a target="_blank" href="http://wordpress.org/extend/plugins/yop-poll/"><b><?php _e( 'plugin page', 'yop_poll' ); ?>.</b></a>
							</li>
							<li>
								<a target="_blank" href="http://twitter.com/home?status=I+use+YOP+POLL+for+WordPress+and+you+should+too+-+http%3A%2F%2Fwordpress.org%2Fextend%2Fplugins%2Fyop-poll%2F"><b><?php _e( 'Tweet about it', 'yop_poll' ); ?>.</b></a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="postbox " id="linksubmitdiv1">
					...
					<h3 class="hndle"><span><?php _e( 'Need Help?', 'yop_poll' ); ?></span></h3>
					<div class="inside">
						<b><?php _e( 'If you need help getting this plugin or have found a bug please visit the ', 'yop_poll' ); ?><a href="http://wordpress.org/support/plugin/yop-poll" target="_blank"><?php _e( 'support forums', 'yop_poll' ); ?></a>!</b>
					</div>
				</div>
				...
				<?php
					...
					<div class="postbox " id="linksubmitdiv2">
						...
						<h3 class="hndle"><span><?php _e( 'The Latest About Yop Poll', 'yop_poll' ); ?></span></h3>
						<div class="inside">
							<ul id="news_ul">
								<?php
				...
				<div class="postbox " id="linksubmitdiv3">
					...
					<h3 class="hndle"><span><font size="-1"><?php _e( 'Get The Latest News From The Team', 'yop_poll' ); ?></font></span></h3>
					<div class="inside">
		...
		<div id="WFItem394041" class="wf-formTpl">
			<form accept-charset="utf-8" action="https://app.getresponse.com/add_contact_webform.html" method="post" target="_top">
				<div class="box">
		...
		public function popup_bar() {
			...
			if ( $date_30_days_before >= $yop_poll_first_install_date  ) {
				...
				<div class="updated">
					...
					<p>
						<input type="button" class="button " value="<?php _e( 'Support This Plugin', 'yop_poll' ) ?>" onclick="document.location.href='<?php echo esc_url( add_query_arg( array( 'yop_poll_support_plugin' => 'yes', '_wpnonce' => wp_create_nonce('yop_poll_donate_addmin_notices') ) ) ); ?>'" />
						<input type="button" class="button " value="<?php _e( 'Rate it 5&#9733;\'s', 'yop_poll') ?>" onclick="document.location.href='<?php echo esc_url( add_query_arg( array( 'yop_poll_rate_plugin' => 'yes', '_wpnonce' => wp_create_nonce('yop_poll_donate_addmin_notices') ) ) ); ?>'" />
						<input type="button" class="button " value="<?php _e( 'Tell Your Followers', 'yop_poll' ) ?>" onclick="document.location.href='<?php echo esc_url( add_query_arg( array( 'yop_poll_tell_followers' => 'yes', '_wpnonce' => wp_create_nonce('yop_poll_donate_addmin_notices') ) ) ); ?>'" />
						<input type="button" class="button " value="<?php _e( 'Don\'t Bug Me Again', 'yop_poll' ) ?>" onclick="document.location.href='<?php echo esc_url( add_query_arg( array( 'yop_poll_do_not_bug' => 'yes', '_wpnonce' => wp_create_nonce('yop_poll_donate_addmin_notices') ) ) ); ?>'" />
					</p>
				</div>
				<?php
				}
