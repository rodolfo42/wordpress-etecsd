...
function thsp_content_nav( $nav_id ) {
	...
	<?php elseif ( $wp_query->max_num_pages > 1 && ( is_home() || is_archive() || is_search() ) ) : // navigation links for home, archive, and search pages ?>
		...
		?>
			...
			<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Noticias anteriores', 'cazuela' ) ); ?></div>
			<?php endif; ?>
	
			<?php if ( get_previous_posts_link() ) : ?>
			<div class="nav-next"><?php previous_posts_link( __( 'Noticias recentes <span class="meta-nav">&rarr;</span>', 'cazuela' ) ); ?></div>
			<?php endif; ?>
...
function thsp_posted_on() {
	printf( __( 'publicado em <a href="%1$s" title="%2$s" rel="bookmark"><time class="entry-date" datetime="%3$s" pubdate>%4$s</time></a>', 'cazuela' ),
